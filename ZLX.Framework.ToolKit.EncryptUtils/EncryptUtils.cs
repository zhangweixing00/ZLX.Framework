...
namespace ZLX.Framework.ToolKit.Encrypt
{
    public sealed class EncryptUtils
    {
        ...
        public static byte[] DES3Encrypt(byte[] data, string key)
        {
            TripleDESCryptoServiceProvider DES = new TripleDESCryptoServiceProvider();
            MD5CryptoServiceProvider hashmd5 = new MD5CryptoServiceProvider();
            byte[] tdesKey = hashmd5.ComputeHash(UTF8Encoding.UTF8.GetBytes(key));
            DES.Key = tdesKey;
            DES.Mode = CipherMode.ECB;//CBC模式不行？
            DES.Padding = PaddingMode.PKCS7;
        ...
        public static byte[] DES3Decrypt(byte[] data, string key)
        {
            TripleDESCryptoServiceProvider DES = new TripleDESCryptoServiceProvider();
